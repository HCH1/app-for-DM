...
i1_v1$bk1 <- gsub("[^\\(]", "", i1_v1$Description)
i1_v1$bk2 <- gsub("[^\\)]", "", i1_v1$Description)
i1_v1$bk3 <- gsub("[^\\[]", "", i1_v1$Description)
i1_v1$bk4 <- gsub("[^\\]]", "", i1_v1$Description)
i1_v1$bk5 <- gsub("[^\\{]", "", i1_v1$Description)
i1_v1$bk6 <- gsub("[^\\}]", "", i1_v1$Description)

i1_v1$bk_check12 <- ifelse(i1_v1$bk1 == i1_v1$bk2,"1","0")
i1_v1$bk_check34 <- ifelse(i1_v1$bk3 == i1_v1$bk4,"1","0")
i1_v1$bk_check56 <- ifelse(i1_v1$bk5 == i1_v1$bk6,"1","0")
...
file = paste(format(Sys.time(), "%Y%m%d_%H"), "_DMC bracket v1.csv", sep = "") )
###
