...
filename1 <- paste( "28SL_Migration__Bulk_Upload_", i, "_start_", from1-1, "_end_", end1-1, ".csv", sep="" )
#write.csv(x = mx_split, col.names=FALSE, file = filename1)
write.table( mx_split, file = filename1, sep= ",", col.names=FALSE, row.names=FALSE)
