...
##input:
i1 = read.csv("1 130BCD_Rev0.9_5.0_DRC01_internal.psv.csv", header = TRUE, stringsAsFactors=FALSE)
TV_uwant = "DM-000282"
#i1 = read.csv("1 Editable V0100FINAL DM000450 (Rev. 1.0_0.3) - Copy.csv", header = TRUE, stringsAsFactors=FALSE)
i2 = read.csv("2 LCN-003181 130G-LP (v42).csv", header = TRUE, stringsAsFactors=FALSE)
